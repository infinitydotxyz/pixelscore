...
export async function getUserNftsFromAlchemy(owner: string, chainId: string, cursor: string, contractAddresses?: string[]) {
...
export async function transformAlchemyNftToPixelScoreNft(alchemyNfts: { alchemyNft: AlchemyNft; chainId: string }[]): Promise<Array<Nft | null>> {
